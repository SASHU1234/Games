...
# Value a
label_1 = tk.Label(win, text = "ax\u00b2\n Value a:", fg="white", bg="#505050")
...
# Value b
label_2 = tk.Label(win, text = "+\nbx\nValue b:", fg="white", bg="#505050")
...
# Watermark
label_4 = tk.Label(win, text = "Created by SASHANTH", fg = "#c0c0c0", bg="#505050")
